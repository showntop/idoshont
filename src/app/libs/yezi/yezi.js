(function(a2, aF) {
  ...
  bI.Callbacks = function(ca) {
    ca = typeof ca === "string" ? (bW[ca] || ae(ca)) : bI.extend({},
    ca);
    ...
    b9 = {
      add: function() {
        if (b7) {
          var cc = b7.length; (function cb(cd) {
            bI.each(cd,
            function(cf, ce) {
              var cg = bI.type(ce);
              if (cg === "function") {
  ...
  function(b1, e) {
    ...
    cl = ct.selectors = {
      ...
      filter: {
        ...
        CLASS: function(e) {
          var df = b3[e + " "];
          return df || (df = new RegExp("(^|" + cn + ")" + e + "(" + cn + "|$)")) && b3(e,
          function(dg) {
  ...
  function(b1, e) {
    bI.cssHooks[e] = {
      get: function(b4, b3, b2) {
        if (b3) {
          return b4.offsetWidth === 0 && F.test(bI.css(b4, "display")) ? bI.swap(b4, bb,
          function() {
            return u(b4, e, b2)
          }) : u(b4, e, b2)
        }
  ...
  function bK(e) {
    return function(b4, b5) {
      ...
      if (bI.isFunction(b5)) {
        while ((b1 = b3[b2++])) {
          if (b1[0] === "+") {
            b1 = b1.slice(1) || "*"; (e[b1] = e[b1] || []).unshift(b5)
  ...
  function r(b2, b3) {
    ...
    for (b1 in b3) {
      if (b3[b1] !== aF) { (b4[b1] ? b2: (e || (e = {})))[b1] = b3[b1]
      }
    }
    if (e) {
      bI.extend(true, b2, e)
  ...
  bI.speed = function(b2, b3, b1) {
    var e = b2 && typeof b2 === "object" ? bI.extend({},
    b2) : {
  ...
  $.AutomLeafStart = function(settings) {
    ...
    $("body").on("click", ".AutomLeaf",
    function() {
      var ID = $(this).attr("ID");
      DropLeaf(ID)
    });
    $("body").on("click", ".AutomLeaffalling",
    function() {
      var ID = $(this).attr("ID");
      LeafTouch(ID)
    });
